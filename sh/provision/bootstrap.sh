...
sudo $PACKAGE_MANAGER -q -y --force-yes install git wget curl dos2unix zfs build-essential libssl-dev linux-image-extra-$(uname -r) apparmor ruby htop mc cowsay
